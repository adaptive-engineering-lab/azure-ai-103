  ...
  return (
    <article className="mx-auto w-full max-w-2xl prose-sm">
      ...
      <Section title="1. About">
        <p>
          {BRANDING.appName} (&ldquo;the Service&rdquo;) is an educational
          study tool for the Microsoft Certified: {BRANDING.certTitle} exam
          (Exam {BRANDING.examCode}). It is operated by{' '}
          <strong>{OPERATOR_NAME}</strong>, operating from {OPERATOR_JURISDICTION}.
        </p>
        <p className="mt-2">
          The Service is <strong>not affiliated with, endorsed by, or
          sponsored by Microsoft</strong>. &ldquo;{BRANDING.examCode}&rdquo; and
      ...
      <Section title="5. Content accuracy">
        <p>
          ...
          {BRANDING.examCode} exam objectives at the time of writing. Microsoft updates
