...
const MODES: Mode[] = [
  ...
  },
  {
    ...
    title: 'Code Review',
    emoji: '🔍',
    description: 'Spot the bug or fill the blank in real Foundry snippets.',
    details: 'Short Python SDK and tool-schema snippets with four-option feedback. Mirrors the exam’s scenario questions.',
